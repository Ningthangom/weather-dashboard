...
searchBtn.click(function () {
    ...
    var currentWeatherapi = "https://api.openweathermap.org/data/2.5/weather?q=" + cityInput + "&Appid=" + apikey + "&units=imperial";

    var fivedayapi = "https://api.openweathermap.org/data/2.5/forecast?q=" + cityInput + "&Appid=" + apikey + "&units=imperial";
    ...
    if (cityInput == "") {
        ...
        $.ajax({
            ...
            $.ajax({
                ...
                if(res.value>3) {
                    currentWeather.append("<p>"+"please put on sun screen if you are going outside" + "</p>").addId("warning").addClass("card-text").addClass("UV")
                }
            });
        ...
        $.ajax({
            ...
            dayArray.forEach(function (i) {
                ...
                fiveDayDiv.append("<div class=fiveDayColor>" + "<p>" + FiveDayUTC1 + "</p>" + `<img src="https://openweathermap.org/img/wn/${res.list[i].weather[0].icon}@2x.png">` + "<p>" + "Temperature: " + res.list[i].main.temp+ "◦C " + "</p>" + "<p>" + "Humidity: " + res.list[i].main.humidity + "%" + "</p>" + "<p>" + "Humidity: " + res.list[i].main.humidity + "%" + "</p>" + "</div>");
